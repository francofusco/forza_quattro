...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'solved_forza_quattro.data';
      var REMOTE_PACKAGE_BASE = 'solved_forza_quattro.data';
  ...
  Module['FS_createPath']("/", "data", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_solved_forza_quattro.data');

      };
      Module['addRunDependency']('datafile_solved_forza_quattro.data');
   ...
   loadPackage({"files": [{"filename": "/data/dummy", "start": 0, "end": 0, "audio": 0}], "remote_package_size": 0, "package_uuid": "a190abcd-a610-4f7d-9d0e-f7359591c4c2"});
...
var wasmBinaryFile = 'solved_forza_quattro.wasm';
...
var ASM_CONSTS = {
  52552: function() {var canvas = document.getElementById('canvas'); canvas.style.width = (canvas.width / window.devicePixelRatio) + 'px'; canvas.style.height = (canvas.height / window.devicePixelRatio) + 'px';},  
 52742: function() {setTimeout(function() { var canvas = document.getElementById('canvas'); canvas.style.width = (canvas.width / window.devicePixelRatio) + 'px'; canvas.style.height = (canvas.height / window.devicePixelRatio) + 'px'; }, 0);}
};
